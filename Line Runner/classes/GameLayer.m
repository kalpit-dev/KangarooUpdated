...
-(id) init
{
	...
	if( (self=[super init])) {
        ...
        if (linkflag==FALSE) {
            ...
            {
                getfree.scaleX = 0.35f;
                getfree.scaleY = 0.35f;
            }
...
//    {
   ...
   // }
    ...
    NSLog(@"Hops:%@",ad.adObject.strPlayScore);
    NSLog(@"Current Hops:%d",intTotalHops);
    
//    intTotalHops += [ad.adObject.strPlayScore intValue];
//    [ad settingScore];
//    NSLog(@"Final Hops:%@",ad.adObject.strPlayScore);
